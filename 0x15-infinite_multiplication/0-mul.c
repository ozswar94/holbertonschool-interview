 ...
 * @len: len of array
 */
static void pproduct(int *product, size_t len)
{
	size_t i;
 ...
 */
static void mul(int *product, char *n1, char *n2, size_t len1, size_t len2)
{
	int i, j, carry;
